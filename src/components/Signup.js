        ...
        <div className="main-content">
          ...
          <div className="side-2">
            <div className="form">
              ...
              <div className="rows">
                <div className="col-1">
                  <label for="">Firstname <span className="is-required">*</span></label><br />
                ...
                <div className="col-1">
                  <label for="">Lastname <span className="is-required">*</span></label><br />
              ...
              <div className="rows">
                <div className="col-1">
                  <label for="">Phone Number <span className="is-required"></span></label><br />
                  <input type="number" name="phone" id="phone" placeholder="Type your Phone Number" /><br />
                  <span id="error-message" className="error"></span>
                </div>
                <div className="col-1">
                  <label for="">Address <span className="is-required"></span></label><br />
